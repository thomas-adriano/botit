    ...
    public static void main(String[] args) {
        ...
        bot.runScript(
                new Script()
                        ...
                        .thenAfter(CAST, F2, times(14),
                                new Script().usePot(_1, POT_INVERVAL))
                        .thenAfter(CAST, F2, times(25),
                                new Script().usePot(_3, POT_INVERVAL))
                        .thenAfter(CAST, F2, times(15),
                                new Script().usePot(_2, POT_INVERVAL))
        );
    }
